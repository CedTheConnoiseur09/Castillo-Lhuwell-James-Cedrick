...
<head>
  ...
  <title>Ced Castillo | Portfolio</title>
...
<body>
  ...
  <div class="hero">
    <div class="avatar-container">
      <img src="https://scontent.fceb1-2.fna.fbcdn.net/v/t39.30808-6/582751150_1791516205573099_1938160637903011346_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=6ee11a&_nc_eui2=AeGdPSLr1dFNLo6LewomGBxCc28JZxIcBY5zbwlnEhwFjr56plSI_pJmDjZPvQ9hUCHNiIaFomQepe9C1bGe2V1w&_nc_ohc=9KKCFhauSIIQ7kNvwFNugEr&_nc_oc=Adkl8QtJQQ18JCpr-18jgj5mdhF7Sk_4gFcmNjnKDJa7qD8HpO3NixYiNPZWWokrTOA&_nc_zt=23&_nc_ht=scontent.fceb1-2.fna&_nc_gid=WFiH9UKQwDDUllGHuaJIZw&oh=00_Afk4HdWvJaFdgvmvHXVPQghK0V0nZg0rr14kvBXUeGms_w&oe=693B615C" 
           alt="Ced Castillo" 
  ...
  <section id="about" class="active">
    <h2>About Me</h2>
    <p>I'm a passionate Online Voting Web Developer, specializing in building efficient, secure, and responsive web applications for online voting systems. I create robust solutions that ensure transparency, security, and user-friendly experiences in digital voting platforms.</p>
  </section>

  <section id="skills">
    <h2>My Skills</h2>
    <div class="skills-list">
      <div class="skill-item">Online Voting Systems</div>
      ...
      <div class="skill-item">AJAX</div>
      <div class="skill-item">Music Production</div>
      <div class="skill-item">Rapping</div>
      <div class="skill-item">Songwriting</div>
    </div>
  </section>
  ...
  <section id="projects">
    ...
    <div class="photos-grid">
      ...
      <div class="photo-card">
        <div class="photo-container">
          <img src="images/photo3.jpg" alt="Photo 3" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22300%22%3E%3Crect fill=%22%23003366%22 width=%22400%22 height=%22300%22/%3E%3Ctext fill=%22%23ffffff%22 font-family=%22Arial%22 font-size=%2220%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22%3EPhoto 3%3C/text%3E%3C/svg%3E';">
        </div>
        <div class="photo-overlay">
          <p>Photo 3</p>
        </div>
      ...
      <div class="photo-card">
        <div class="photo-container">
          <img src="images/photo4.jpg" alt="Photo 4" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22300%22%3E%3Crect fill=%22%23003366%22 width=%22400%22 height=%22300%22/%3E%3Ctext fill=%22%23ffffff%22 font-family=%22Arial%22 font-size=%2220%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22%3EPhoto 4%3C/text%3E%3C/svg%3E';">
        </div>
        <div class="photo-overlay">
          <p>Photo 4</p>
        </div>
  ...
  <section id="contact">
    <h2>Contact</h2>
    <p>Email: <a href="mailto:cedzoldyck09@gmail.com">cedzoldyck09@gmail.com</a></p>
    <p>Facebook: <a href="https://www.facebook.com/ce.ddyii.5" target="_blank">Ced Castillo</a></p>
    <p>Phone: 09060632079</p>
  </section>

  <footer>
    <p>&copy; <span id="currentYear">2024</span> Ced Castillo | All Rights Reserved.</p>
  </footer>
  ...
  <script>
    ...
    const roles = [
      "Hi! I'm Ced Castillo",
      "I'm an Online Voting Developer",
      "I'm also a Music Rapper"
    ];
    let currentRole = 0;
    let charIndex = 0;
